  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <p className="text-ink-soft leading-relaxed mb-8">
        The questions you&apos;ll actually be asked about agents, orchestration, and
        frameworks — with crisp model answers. Read them, then try answering in your own words.
      </p>
