...
const KEY = "aws-academy-activity-v1";

/** Every key this academy owns — the unit of export, import, and reset. */
export const STORAGE_KEYS = [
  "aws-academy-progress-v1",
  "aws-academy-mastery-v1",
  "aws-academy-review-v1",
  "aws-academy-exam-v1",
  KEY,
] as const;
...
export function useDownloadBackup() {
  return useCallback(() => {
    ...
    a.href = url;
    a.download = `aws-academy-progress-${dayKey()}.json`;
    a.click();
