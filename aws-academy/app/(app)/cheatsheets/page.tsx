  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <p className="text-ink-soft leading-relaxed mb-8">
        The AWS CLI commands you reach for daily — {totalCommands} across identity, EC2 and
        VPC, S3, IAM, Lambda, containers, CloudWatch, and CloudFormation. Hover a command
        to copy it.
      </p>
