...
export const metadata = {
  title: "ML Pattern Catalog — Interview Academy",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <p className="text-ink-soft leading-relaxed mb-10">
        The recurring good habits behind strong ML work — the kind of judgment interviewers
        listen for. For each: a diagram, when to reach for it, and what to watch out for.
      </p>
