  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <p className="text-ink-soft leading-relaxed mb-8">
        The AI &amp; machine-learning questions you&apos;ll actually be asked — with crisp,
        full model answers written the way you&apos;d want to say them out loud. Read one, then try
        answering in your own words before you reveal it.
      </p>
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full rounded-xl border border-canvas-300 bg-canvas-50/60 pl-10 pr-4 py-2.5 text-ink placeholder:text-ink-faint focus:outline-none focus:border-iris/50"
        />
      </div>
          ...
          <button
            ...
            className={`text-sm rounded-full px-3.5 py-1.5 border transition-colors ${
              topic === t
                ...
                : "bg-canvas-50/40 text-ink-soft border-canvas-300 hover:border-iris/40"
            }`}
          >
            {t}
          </button>
      ...
      <div className="space-y-3">
        {filtered.map((item) => {
          ...
          return (
            <div
              key={item.q}
              className={`rounded-xl border bg-canvas-50/40 overflow-hidden transition-colors ${
                isOpen ? "border-iris/40" : "border-canvas-300 hover:border-iris/30"
              }`}
            >
              <button
              ...
              >
                <span className="text-[0.65rem] font-semibold uppercase tracking-wide text-iris-dark bg-iris-50 rounded px-1.5 py-0.5 mt-0.5 shrink-0">
                  {item.topic}
                </span>
              ...
              {isOpen && (
                <div className="px-5 pb-5 pt-0 animate-accordion">
                  <p className="text-ink-soft leading-relaxed border-l-2 border-iris/40 pl-4">
                    {item.a}
                  </p>
                </div>
              )}
