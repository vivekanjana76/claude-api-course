  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <p className="text-ink-soft leading-relaxed mb-8">
        The formulas and techniques worth memorizing — {totalCommands} across classification and
        regression metrics, training essentials, and the LLM toolkit. Hover an entry to copy it.
      </p>
