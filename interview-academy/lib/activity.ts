...
const KEY = "interview-academy-activity-v1";

/** Every key this academy owns — the unit of export, import, and reset. */
export const STORAGE_KEYS = [
  "interview-academy-progress-v1",
  "interview-academy-mastery-v1",
  "interview-academy-review-v1",
  "interview-academy-exam-v1",
  KEY,
] as const;
...
export function importState(raw: string): { applied: number; error?: string } {
  ...
  if (parsed.app !== "interview-academy") {
    return {
      applied: 0,
...
export function useDownloadBackup() {
  return useCallback(() => {
    ...
    a.href = url;
    a.download = `interview-academy-progress-${dayKey()}.json`;
    a.click();
