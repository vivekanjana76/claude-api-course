  ...
  const content = (
    <nav className="flex flex-col h-full">
      ...
      <div className="border-t border-canvas-300 px-3 py-3 space-y-1">
        ...
        <FooterLink href="/prep" label="Intuition Prep" icon={<Zap size={15} />} active={pathname === "/prep"} onClick={() => setOpen(false)} />
        <FooterLink href="/patterns" label="Architecture Catalog" icon={<Workflow size={15} />} active={pathname === "/patterns"} onClick={() => setOpen(false)} />
