  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <p className="text-ink-soft leading-relaxed mb-8">
        The calls and commands you reach for daily — {totalCommands} across the Anthropic SDK,
        tool use and MCP, embeddings and retrieval, and evals. Hover one to copy it.
      </p>
