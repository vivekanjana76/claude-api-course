...
export const metadata = {
  title: "GenAI Architecture Catalog — AI Engineer Academy",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <h1 className="font-display text-4xl font-semibold text-ink mb-3 tracking-tight">
        GenAI Architecture Catalog
      </h1>
      <p className="text-ink-soft leading-relaxed mb-10">
        The recurring shapes of GenAI systems — the ones you&apos;ll be asked to draw on a
