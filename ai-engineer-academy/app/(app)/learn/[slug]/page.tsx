...
export function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  if (!ref) return {};
  return { title: `${ref.lesson.title} — AI Engineer Academy` };
}
        ...
        {prev ? (
          ...
          >
            <span className="flex items-center gap-1 text-xs text-ink-muted mb-1">
              ...
              <kbd className="ml-1 hidden sm:inline text-[0.62rem] border border-canvas-300 rounded px-1 py-0.5">←</kbd>
            </span>
        ...
        {next && (
          ...
          >
            <span className="flex items-center justify-end gap-1 text-xs text-ink-muted mb-1">
              <kbd className="mr-1 hidden sm:inline text-[0.62rem] border border-canvas-300 rounded px-1 py-0.5">→</kbd>
