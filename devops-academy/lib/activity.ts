...
const KEY = "devops-academy-activity-v1";

/** Every key this academy owns — the unit of export, import, and reset. */
export const STORAGE_KEYS = [
  "devops-academy-progress-v1",
  "devops-academy-mastery-v1",
  "devops-academy-review-v1",
  "devops-academy-exam-v1",
  KEY,
] as const;
...
export function useDownloadBackup() {
  return useCallback(() => {
    ...
    a.href = url;
    a.download = `devops-academy-progress-${dayKey()}.json`;
    a.click();
