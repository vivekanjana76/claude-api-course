  ...
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <p className="text-ink-soft leading-relaxed mb-8">
        The commands you reach for daily — {totalCommands} across the AWS CLI, the Azure CLI,
        and the service-by-service mapping between the two clouds. Hover a command to copy it.
      </p>
