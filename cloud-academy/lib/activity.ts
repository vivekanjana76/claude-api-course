...
const KEY = "cloud-academy-activity-v1";

/** Every key this academy owns — the unit of export, import, and reset. */
export const STORAGE_KEYS = [
  "cloud-academy-progress-v1",
  "cloud-academy-mastery-v1",
  "cloud-academy-review-v1",
  "cloud-academy-exam-v1",
  KEY,
] as const;
...
export function useDownloadBackup() {
  return useCallback(() => {
    ...
    a.href = url;
    a.download = `cloud-academy-progress-${dayKey()}.json`;
    a.click();
