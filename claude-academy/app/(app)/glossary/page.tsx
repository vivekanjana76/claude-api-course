    ...
    <div className="max-w-3xl mx-auto px-6 lg:px-10 py-12">
      ...
      <div className="relative mb-8 sticky top-4 z-10">
        ...
        <input
          ...
          className="w-full rounded-xl border border-cream-300 bg-cream-50 pl-10 pr-4 py-2.5 text-ink placeholder:text-ink-faint focus:outline-none focus:border-clay/50 shadow-sm"
        />
      </div>
