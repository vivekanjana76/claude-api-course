...
const KEY = "claude-academy-activity-v1";

/** Every key this academy owns — the unit of export, import, and reset. */
export const STORAGE_KEYS = [
  "claude-academy-progress-v1",
  "claude-academy-mastery-v1",
  "claude-academy-review-v1",
  "claude-academy-exam-v1",
  KEY,
] as const;
...
export function useDownloadBackup() {
  return useCallback(() => {
    ...
    a.href = url;
    a.download = `claude-academy-progress-${dayKey()}.json`;
    a.click();
